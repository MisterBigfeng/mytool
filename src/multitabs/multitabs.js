...
if (typeof jQuery === "undefined") {
    ...
    defaultLayoutTemplates = {
        ...
        '   <div class="mt-nav-bar {navBarClass}" style="background-color: {backgroundColor};height:35px;">' +
        '       <div class="mt-nav mt-nav-tools-left">' +
        '           <ul  class="nav {nav-tabs}">' +
        '               <li class="mt-move-left" style="height:35px;"><a><i class=""></i></a></li>' +
        '           </ul>' +
        '       </div>' +
        '       <nav class="mt-nav mt-nav-panel" style="height:35px;">' +
        '           <ul  class="nav {nav-tabs}" style="height:35px;line-height:14px;">' +
        ...
        '               <li class="mt-dropdown dropdown" style="height:35px;">' +
        '                   <a href="#"  class="dropdown-toggle" style="height:35px;" data-toggle="dropdown">{dropdown}<span class="caret"></span></a>' +
        ...
        closeBtn: ' <i class="mt-close-tab fa fa-times show-i" style="{style}"></i>',
    ...
    MultiTabs.prototype = {
        ...
        _listen: function () {
            ...
            handler($el.navBar, 'click', '.mt-close-tab', function () {
                ...
                var closeTxt = $(this).closest('li')[0].innerHTML;
                var reg = /[0-9\u4e00-\u9fa5]/g;
                console.info('你刚才关闭了' + closeTxt.match(reg) + '页面');
    ...
    $.fn.multitabs.defaults = {
        showHash: true,                           //While is true, show hash in URL.
